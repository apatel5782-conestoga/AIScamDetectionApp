        ...
        <div>
          ...
          {activeLocationLabel && (
            <p className="mt-1 text-sm text-gray-500">
              Showing {articles.length > 0 ? `${articles.length} ` : ""}results for{" "}
              <span className="font-medium text-blue-600">{activeLocationLabel}</span>
            </p>
          )}
        </div>
      ...
      <div className="mt-5">
        ...
        {!loading && !error && articles.length === 0 && (
          <p className="text-sm text-gray-500">
            No local fraud or scam coverage found for this city right now. Try another nearby city or regional name.
          </p>
        )}
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-2 text-xs text-gray-500">
                    ...
                    >
                      {article.sourceType === "official" ? "Official" : "Media"}
                    </span>
                    <span>&middot;</span>
